...
import { FhiAngularHighchartsData } from './fhi-angular-highcharts/_fhi-angular-highcharts.data';
...
export class LibraryItemSegmentPaths {
  ...
  // Modules
  static fhiAngularHighcharts = stringTransform(Object.keys({ FhiAngularHighchartsData })[0]);
