              ...
              <div class="fhi-utility-section__group">
                <div class="my-1 py-1">
                  <a class="d-flex text-white" href="javascript:void(0)">
                    <span class="icon-person icon-white icon-lg me-2 mt-n1"></span>
                    Innlogget Bruker
                  </a>
                </div>
                <div class="my-1 py-1">
                  <a class="d-flex text-white" href="javascript:void(0)">
                    <span class="icon-bell icon-white icon-lg me-2 mt-n1"></span>
                    Varslinger
                  </a>
                </div>
                <div class="my-1 py-1">
                  <a class="d-flex text-white" href="javascript:void(0)">
                    <span class="icon-question-circle icon-white icon-lg me-2 mt-n1"></span>
                    Hjelp
                  </a>
                </div>
              </div>
