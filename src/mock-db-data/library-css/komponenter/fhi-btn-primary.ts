...
<div class="d-flex flex-column flex-lg-row mb-4 mb-lg-0">
  <a role="button" class="btn btn-sm fhi-btn-primary mb-3 me-3">Liten, 120px</a>
...
<div class="d-flex flex-column flex-lg-row">
  <a type="button" class="btn btn-sm fhi-btn-outline-primary mb-3 mb-lg-0 me-3">Liten, 120px</a>
