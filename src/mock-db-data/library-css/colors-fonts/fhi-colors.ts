...
export const FhiColors: LibraryExample[] = [{
  title: 'Fargepalett',
  exampleHtml: `
<p class="text-muted small mt-2 mb-0">Lyse gråtoner</p>
...
<p class="text-muted small mt-2 mb-0">Gråtoner</p>
${colorHtml('#cfd0cb', 'fhi-grey-1')}
${colorHtml('#9f9f9f', 'fhi-grey-2')}
${colorHtml('#767676', 'fhi-grey-3')}
${colorHtml('#222222', 'fhi-grey-4')}

<p class="text-muted small mt-2 mb-0">Koksgrå/Antrasitt</p>
${colorHtml('#333841', 'fhi-charcoal-1')}

<p class="text-muted small mt-2 mb-0">Blågrått</p>
...
<p class="text-muted small mt-2 mb-0">Lys blå</p>
...
<p class="text-muted small mt-2 mb-0">Rødt</p>
