...
2. Do as decribed under [Release branches for library projects](#release-branches-for-library-projects)
   ...
   3. Create PR, and when approved, make sure commit message is the same as the branch name, except for uppercase R in Release, and then merge release branch to `fhi-[project]/vX` (deploy).
