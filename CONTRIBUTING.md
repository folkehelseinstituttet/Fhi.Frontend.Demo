...
So you're thinking about contributing to Fhi.Frontend.Demo? Great! Maintaining and enhancing Fhi.Frontend.Demo is a big job, so **the community's help is really appreciated.**
...
- Ensure you are running the [latest version](https://github.com/folkehelseinstituttet/Fhi.Frontend.Demo/releases) of Fhi.Frontend.Demo
- **Search** the [issue list](https://github.com/folkehelseinstituttet/Fhi.Frontend.Demo/issues?utf8=✓&q=is%3Aissue) (including closed issues) to make sure it hasn't already been reported.
...
Great documentation is essential for any open source project and Fhi.Frontend.Demo is no exception. [Our README](https://github.com/folkehelseinstituttet/Fhi.Frontend.Demo/blob/main/README.md) often lags behind the features that have been implemented or would benefit from better examples.

**PS.** If you would like to contribute to creating an exended, and better, documentation in the form of a [Wiki](https://github.com/folkehelseinstituttet/Fhi.Frontend.Demo/wiki), help is really appreciated!
